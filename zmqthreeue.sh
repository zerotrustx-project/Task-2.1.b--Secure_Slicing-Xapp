...
curl -i -X POST -H "Content-type: application/json" -d '{"imsi":"001010123456781"}' http://${SS_XAPP}:8000/v1/ues ; echo ; echo
echo Listing Ues: ; echo
curl -i -X GET http://${SS_XAPP}:8000/v1/ues ; echo ; echo
...
curl -i -X POST http://${SS_XAPP}:8000/v1/slices/fast/ues/001010123456781 ; echo ; echo
echo "Getting Slice (name=fast):" ; echo
curl -i -X GET http://${SS_XAPP}:8000/v1/slices/fast; echo ; echo
